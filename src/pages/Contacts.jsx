...
const Contacts = () => {
  ...
  const uniqueLocations = useMemo(() => [...new Set(communityMembers.map(member => member.location))], []);
        ...
        {filteredMembers.map(member => (
          <Card key={member.id} className="hover:shadow-lg transition-shadow">
            <CardContent className="p-4">
              ...
              <p className="text-gray-500 mb-2">{member.company}</p>
              <p className="text-gray-500 mb-4">{member.location}</p>
              <Dialog>
