  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="border-4 border-primary rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
      ...
      <div className="mt-8 border-4 border-primary rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
